...
export const TUTORIALS: Tutorial[] = [
    ...
    },
    {
        ...
        minTier: "staff",
        icon: "ShieldCheck",
        autoStartOn: "/staff/pull-requests",
        steps: [
            { id: "intro", placement: "center", route: "/staff/pull-requests" },
            { id: "queue", target: '[data-tutorial="staff-nav-prs"]', placement: "bottom", waitForTarget: true },
    ...
    },
    {
        ...
        autoStartOn: "/staff",
        steps: [
            { id: "intro", placement: "center", route: "/staff" },
            { id: "flags", target: '[data-tutorial="staff-nav-flags"]', placement: "bottom", waitForTarget: true },
            { id: "directories", target: '[data-tutorial="staff-nav-content"]', placement: "bottom", waitForTarget: true },
            { id: "featured", target: '[data-tutorial="staff-nav-content"]', placement: "bottom", waitForTarget: true },
            { id: "outro", placement: "center" },
        ],
    },
];
