...
os.environ.setdefault("EUROOFFICE_JWT_SECRET", "test-eurooffice-jwt-secret-for-pytest-only")
os.environ.setdefault("EUROOFFICE_FILE_TOKEN_SECRET", "test-eurooffice-file-token-secret-pytest")
