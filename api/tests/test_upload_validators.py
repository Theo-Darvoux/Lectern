...
class TestValidateFilename:
    ...
    def test_empty_filename_raises(self):
        with pytest.raises(BadRequestError) as exc_info:
            _validate_filename("")
        assert exc_info.value.code == UploadErrorCode.TYPE_NOT_ALLOWED
    ...
    def test_filename_too_long_raises(self):
        ...
        assert exc_info.value.code == UploadErrorCode.FILENAME_TOO_LONG
...
class TestCheckPerTypeSize:
    ...
    def test_image_exceeds_limit(self):
        ...
        assert exc_info.value.code == UploadErrorCode.FILE_TOO_LARGE
...
class TestApplyMimeCorrection:
    ...
    def test_extension_mime_mismatch_raises(self):
        ...
        assert exc_info.value.code == UploadErrorCode.MIME_MISMATCH
